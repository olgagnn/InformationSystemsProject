...
def load_data(csv_file):
    ...
    X = df.drop('target', axis=1)  # Features (assuming the target column is named 'target')
...
analysis = tune.run(
    train_and_evaluate,
    config={},  # Using default Logistic Regression parameters (no hyperparameter tuning)
    num_samples=2,  
